  ...
  if (loading || user) {
    return (
      <div className="flex h-screen w-full flex-col items-center justify-center bg-background">
        <Palette className="h-16 w-16 animate-pulse text-primary" />
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center bg-background p-8 text-center">
        ...
        <p className="mt-4 max-w-2xl text-lg text-foreground/80">
          ArtistLive gives you the tools to stream your creative process to the world. From your browser or OBS, share your art, connect with your audience, and build your community.
        </p>
