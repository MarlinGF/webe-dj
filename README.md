...
- **Dual-Deck Player**: Independent playback controls for two tracks with manual and automated queuing.
- **Manual & Auto Crossfade**: Smoothly blend between decks with adjustable fade speed and manual "Start Crossfade" control.
